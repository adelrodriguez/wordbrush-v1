  ...
  return (
    <div>
      ...
      <div className="lg:pl-20">
          ...
          <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            {showSearch ? (
              <Form action="#" className="relative flex flex-1" method="GET">
                ...
                />
                <input
                  className="form-input block h-full w-full border-0 py-0 pl-8 pr-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm"
                  id="search-field"
                  name="search"
                  onChange={(event) => {
              ...
              <Menu as="div" className="relative">
                <Menu.Button className="-m-1.5 flex items-center p-1.5">
                  ...
                  <img
                    ...
                    src={
                      "https://source.boringavatars.com/pixel/32/" +
        ...
        <main className="px-4 py-10 sm:px-6 lg:px-10 lg:py-6">
          <Outlet />
        </main>
      </div>
    </div>
